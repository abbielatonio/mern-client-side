...
function Practitioners() {
    ...
    const {data, loading, error} = useFetch(`http://localhost:4000/practitioners?modality=${modality}&deleted=false`);



    
  return (  //............cut searchbar sa ibang pages
    <div>
...
<input type="text" placeholder={city} />
            ...
            <input type="text" placeholder={modality} />
...
Search</button>
   ...
   <h3> Showing all results for {modality}:</h3>
