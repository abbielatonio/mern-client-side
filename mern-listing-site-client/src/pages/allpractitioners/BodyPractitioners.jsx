...
function BodyPractitioners() {
  ...
  const {data, loading, error} = useFetch(`http://localhost:4000/practitioners?category=Body&deleted=false`);
...
export default BodyPractitioners
